...
function toggleSidebar() {
    ...
    return(
        ...
        <ul>
            ...
            <button className="toggle-btn" id="toggleSide" onclick="toggleSidebar()">
            ...
            <a href="#" onclick="toggleSubmenu(event)" title="Stations" id="drop">
                ...
                <span>Stations</span>
                <svg className="arrow" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#0000F5"><path d="M480-360 280-560h400L480-360Z" /></svg>
            </a>
